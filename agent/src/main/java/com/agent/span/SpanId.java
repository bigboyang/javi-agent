...
import com.agent.logs.sdkLog.ApiUsageLogger;
import com.agent.common.utils.core.TemporaryBuffers;
import com.agent.common.utils.encode.EncodingUtils;
 ...
 *
 * <p>스팬 ID를 생성/검증/변환하는 유틸리티로 사용된다.
 *
...
public final class SpanId {
  ...
  public static String fromBytes(byte[] spanIdBytes) {
    ...
    EncodingUtils.bytesToBase16(spanIdBytes, result, BYTES_LENGTH);
